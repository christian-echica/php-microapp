        ...
        <div class="col-md-6 col-md-offset-3">
          ...
          <form action="" method="post">
            ...
            <table>
              ...
              <?php
                // LIST OF MYSQL SERVERS TO CHOOSE
                //$serverOptions = array("mysql-server:3306","mysql-server:3307","mysql-server:3308");
                //$selectedHostname = $serverOptions[array_rand($serverOptions)];


                // $connection = mysqli_connect("mysql-server:3306","root","mypassword");
                $selectedHostname = "mysql-server:3306";
                $connection = mysqli_connect($selectedHostname,"root","mypassword");
                    ...
                    while($row = mysqli_fetch_array($query_run))
                      {
                        ...
                        echo '<h2>' . 'connected with mysql-db at ' . $selectedHostname . '</h2>';
                        ?>
            </table>
        </center>
      </div>
